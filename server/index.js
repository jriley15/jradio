...
const opt = {
  ...
  filter(format) {
    return (
      format.audioEncoding === preferredAudioFormat &&
...
function addToQueueYT(info) {
  ...
  let song = {
    ...
    thumb: "https://img.youtube.com/vi/" + videoId + "/hqdefault.jpg", //info.thumbnail_url,
    elapsed: 0,
    type: "?",
    title: info.title,
    data: [],
